    ...
    <nav className="navbar navbar-expand-lg navbar-light _header_nav _padd_t10">
      <div className="container _custom_container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div className="_header_nav_profile" style={{ position: 'relative' }} ref={dropRef}>
            <div
              className="_header_nav_profile_image"
              onClick={() => setDropOpen((s) => !s)}
              style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 8 }}
            >
              <div style={{ width: 38, height: 38, borderRadius: '50%', background: '#e0e7ff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, fontWeight: 700, color: '#377DFF' }}>
                {initials}
              </div>
            ...
            <div className={`_nav_profile_dropdown _profile_dropdown${dropOpen ? ' show' : ''}`}>
              <div className="_nav_profile_dropdown_info">
                <div style={{ width: 40, height: 40, borderRadius: '50%', background: '#e0e7ff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14, fontWeight: 700, color: '#377DFF', flexShrink: 0 }}>
                  {initials}
                </div>
